...
export const MOCK_GRAPH: GraphResponse = {
  ...
  edges: [
    // Lula connections
    { id: "e1", from: "pol-lula", to: "scan-mensalao", type: "INVOLVED_IN", properties: { status: "cited", date_from: "2005-06-01" } },
    { id: "e2", from: "pol-lula", to: "scan-lava-jato", type: "DEFENDANT_IN", properties: { status: "convicted", date_from: "2016-09-14" } },
    { id: "e3", from: "pol-lula", to: "org-pt", type: "MEMBER_OF", properties: { status: "membership", date_from: "1980-02-10" } },
    { id: "e4", from: "pol-lula", to: "scan-petrobras", type: "IMPLICATED_IN", properties: { status: "cited", date_from: "2015-01-01" } },
    { id: "e5", from: "pol-lula", to: "leg-lj-principal", type: "DEFENDANT_IN", properties: { status: "convicted" } },
    { id: "e6", from: "pol-lula", to: "org-odebrecht", type: "RELATED_TO", properties: { status: "cited" } },

    // Dirceu connections
    { id: "e7", from: "pol-dirceu", to: "scan-mensalao", type: "INVOLVED_IN", properties: { status: "convicted", date_from: "2005-06-01" } },
    { id: "e8", from: "pol-dirceu", to: "org-pt", type: "MEMBER_OF", properties: { status: "membership" } },
    { id: "e9", from: "pol-dirceu", to: "leg-ap470", type: "DEFENDANT_IN", properties: { status: "convicted" } },

    // Cunha connections
    { id: "e10", from: "pol-cunha", to: "scan-lava-jato", type: "INVOLVED_IN", properties: { status: "convicted", date_from: "2015-01-01" } },
    { id: "e11", from: "pol-cunha", to: "org-mdb", type: "MEMBER_OF", properties: { status: "membership" } },
    { id: "e12", from: "pol-cunha", to: "leg-cunha-cpc", type: "DEFENDANT_IN", properties: { status: "convicted" } },
    { id: "e13", from: "pol-cunha", to: "org-odebrecht", type: "RELATED_TO", properties: { status: "indicted" } },

    // Temer connections
    { id: "e14", from: "pol-temer", to: "scan-lava-jato", type: "IMPLICATED_IN", properties: { status: "indicted", date_from: "2017-06-26" } },
    { id: "e15", from: "pol-temer", to: "org-mdb", type: "MEMBER_OF", properties: { status: "membership" } },
    { id: "e16", from: "pol-temer", to: "org-odebrecht", type: "RELATED_TO", properties: { status: "cited" } },
    { id: "e17", from: "pol-temer", to: "org-oas", type: "RELATED_TO", properties: { status: "cited" } },

    // Aécio connections
    { id: "e18", from: "pol-aecio", to: "scan-lava-jato", type: "IMPLICATED_IN", properties: { status: "indicted", date_from: "2017-05-18" } },
    { id: "e19", from: "pol-aecio", to: "org-andrade-gutierrez", type: "RELATED_TO", properties: { status: "indicted" } },

    // Delcídio connections
    { id: "e20", from: "pol-delcidio", to: "scan-lava-jato", type: "INVOLVED_IN", properties: { status: "convicted", date_from: "2015-11-25" } },
    { id: "e21", from: "pol-delcidio", to: "org-pt", type: "MEMBER_OF", properties: { status: "membership" } },
    { id: "e22", from: "pol-delcidio", to: "org-petrobras", type: "RELATED_TO", properties: { status: "convicted" } },

    // Cabral connections
    { id: "e23", from: "pol-cabral", to: "scan-cabral-rio", type: "INVOLVED_IN", properties: { status: "convicted", date_from: "2007-01-01" } },
    { id: "e24", from: "pol-cabral", to: "org-mdb", type: "MEMBER_OF", properties: { status: "membership" } },
    { id: "e25", from: "pol-cabral", to: "org-odebrecht", type: "RELATED_TO", properties: { status: "convicted" } },
    { id: "e26", from: "pol-cabral", to: "org-andrade-gutierrez", type: "RELATED_TO", properties: { status: "convicted" } },

    // Maluf connections
    { id: "e27", from: "pol-maluf", to: "scan-maluf-duto", type: "INVOLVED_IN", properties: { status: "convicted", date_from: "1993-01-01" } },

    // Collor connections
    { id: "e28", from: "pol-collor", to: "scan-pcfish", type: "INVOLVED_IN", properties: { status: "cited", date_from: "1992-05-01" } },
    { id: "e29", from: "pol-collor", to: "leg-collor-imp", type: "DEFENDANT_IN", properties: { status: "cited" } },

    // Renan connections
    { id: "e30", from: "pol-renan", to: "scan-lava-jato", type: "IMPLICATED_IN", properties: { status: "cited", date_from: "2015-01-01" } },
    { id: "e31", from: "pol-renan", to: "org-mdb", type: "MEMBER_OF", properties: { status: "membership" } },

    // Orgs to scandals
    { id: "e32", from: "org-odebrecht", to: "scan-lava-jato", type: "INVOLVED_IN", properties: { status: "convicted" } },
    { id: "e33", from: "org-oas", to: "scan-lava-jato", type: "INVOLVED_IN", properties: { status: "convicted" } },
    { id: "e34", from: "org-andrade-gutierrez", to: "scan-lava-jato", type: "INVOLVED_IN", properties: { status: "convicted" } },
    { id: "e35", from: "org-petrobras", to: "scan-petrobras", type: "RELATED_TO", properties: { status: "cited" } },
    { id: "e36", from: "org-petrobras", to: "scan-lava-jato", type: "RELATED_TO", properties: { status: "cited" } },

    // Legal proceedings to scandals
    { id: "e37", from: "leg-ap470", to: "scan-mensalao", type: "INVESTIGATES", properties: { status: "membership" } },
    { id: "e38", from: "leg-lj-principal", to: "scan-lava-jato", type: "INVESTIGATES", properties: { status: "membership" } },
    { id: "e39", from: "leg-collor-imp", to: "scan-pcfish", type: "INVESTIGATES", properties: { status: "membership" } },
    { id: "e40", from: "leg-cunha-cpc", to: "scan-lava-jato", type: "INVESTIGATES", properties: { status: "membership" } },
  ],
}
